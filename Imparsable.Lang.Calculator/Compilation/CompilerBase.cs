...
public abstract partial class CompilerBase(SyntaxTree tree, DiagnosticsProvider diagnostics) : Compiler<OpCode>, ISyntaxVisitor
{
    ...
    protected SyntaxTree Tree => tree;

    protected void OnPop(ISymbolTable parent, ISymbolTable child)
    {
    ...
    public virtual void Visit(GroupingExpression node) => node.Expression.Accept(this);
    ...
    public virtual void Visit(ElseIfStatement node)
    {
        EmitOpCode(OpCode.POP);
    ...
    public virtual void Visit(BoolLiteralExpression node)
    {
